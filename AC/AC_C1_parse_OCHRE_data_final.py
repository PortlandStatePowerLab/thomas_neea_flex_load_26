...
input_file_root = "AC_Test_OFFSET_SCHEDULES_4hr_8bin_XMLEDIT"
...
process_data(input_file_1, output_file_1, 'HVAC Cooling Electric Power (kW)')
process_data(input_file_2, output_file_2, 'HVAC Cooling Electric Power (kW)')
