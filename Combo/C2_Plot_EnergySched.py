...
#Creates plots for the average device and total household power consumption, comparing baseline and controlled in energy scheduling
"""
...
input_file_root = 'COMBO_WH_Loadshape_1'
