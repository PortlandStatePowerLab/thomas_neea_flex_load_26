...
default_path = os.path.join(root_path, r".venv\Lib\site-packages\ochre\defaults\Input Files")
building_ID = '0000960'
...
house = Dwelling(
    start_time=dt.datetime(2026, 6, 1, 0, 0),
    time_res=dt.timedelta(minutes=10),
    duration=dt.timedelta(days=3),
    hpxml_file=os.path.join(building_path, "in.xml"),
    hpxml_schedule_file=os.path.join(building_path, "schedules.csv"),
