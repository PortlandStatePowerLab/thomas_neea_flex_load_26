...
output_append_dryerpower = "_battery_power"
...
process_data(input_file_1, output_file_1, 'Battery Electric Power (kW)')
process_data(input_file_2, output_file_2, 'Battery Electric Power (kW)')
...
process_data(input_file_1, output_file_5, 'Battery SOC (-)')
process_data(input_file_2, output_file_6, 'Battery SOC (-)')
