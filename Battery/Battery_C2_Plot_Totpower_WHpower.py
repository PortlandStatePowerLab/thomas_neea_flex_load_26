...
input_file_root = 'Battery_Test_LoadShape_0.5_0.2_0.1'
...
output_append_EVpower = "_battery_power"
...
photo_file_1 = os.path.join(working_dir, "Ready_data", input_file_root, input_file_root + "_Battery_power_plot.png")
...
plot_data(output_file_1, output_file_2, 'Average Power Consumption per Battery System', photo_file_1, "ax1")
...
plot_data(output_file_5, output_file_6, 'Average State of Charge (SOC) per Battery', photo_file_3, "ax3")
