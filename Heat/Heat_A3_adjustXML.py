...
Adjusts Heating properties in the XML file that OCHRE will read.
Updated to dynamically convert all HVAC systems to ASHP or MSHP heating and cooling
"""
...
OUTPUT_DIR = WORKING_DIR / "HVAC All Portland Input Files"
